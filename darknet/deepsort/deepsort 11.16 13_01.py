...
def parser():
    ...
    parser.add_argument("--weights", default="./yolo_files/yolov4-my-model-v2_best.weights",
                        help="yolo weights path")
    parser.add_argument("--dont_show", action='store_true',
                        help="windown inference display. For headless systems")
    parser.add_argument("--ext_output", action='store_true', default=True,
                        help="display bbox coordinates of detected objects")
    parser.add_argument("--config_file", default="./yolo_files/yolov4-my-model-v2.cfg",
...
def inference(darknet_image_queue, detections_queue, fps_queue, cap):
    ...
    while cap.isOpened():
        ...
        #detections_queue.put(detections)  ######################이거다. 이게 고장났다.
