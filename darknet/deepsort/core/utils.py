...
# helper function to convert bounding boxes from normalized xmin, ymin, width, height ---> xmin, ymin, xmax, ymax
def format_yolov4_boxes(bboxes, image_height, image_width):
    for box in bboxes:
        ymin = int(box[1] * image_height)
        xmin = int(box[0] * image_width)
        ymax = int(box[3] - box[1] * image_height)
        xmax = int(box[2] - box[0] * image_width)
