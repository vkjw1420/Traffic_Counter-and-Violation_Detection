...
def video_capture(frame_queue, darknet_image_queue):
    ...
    while cap.isOpened():
        ...
        # if not nonROI2 is None:
        #     roi = cv2.fillConvexPoly(roi, nonROI2, (0,0,0))
    ...
    while cap.isOpened():
        ...
        if frame is not None:
            ...
            for track in tracker.tracks:
                ...
                # 버스 전용 차로 단속
                if track.laneNumber is bus_only_lane and class_name != 'bus':
                    track.busOnly = True
                ...
                elif track.busOnly is True:
                    color = (0,0,255)
                    text_color = (0,255,255)
                    cv2.rectangle(frame, (int(bbox[0]), int(bbox[1])), (int(bbox[2]), int(bbox[3])), color, 2)
                    cv2.putText(frame, "UsingBusLane", (int(bbox[0]), int(bbox[1]-25)),0, 1, text_color,2)
                else:  
...
if __name__ == '__main__':
    ...
    # ROI_xmin = 270; ROI_xmax = 1700; ROI_ymin = 50; ROI_ymax = 800 # 대구
    ...
    # 대구
    # nonROI = np.array([[800, 0], [1425, 550], [1430, 0]], np.int32)
    # nonROI2 = np.array([[370, 0], [0, 470], [0, 0]], np.int32)
    ...
    # 대구
    # lines = (((0, 870), (660, 184)), ((270, 870), (730, 184)), ((570, 870), (800, 184)), ((879, 870), (875, 184)), ((1170, 870), (945, 184)), 
    #                 ((1450, 870), (1015, 184)), ((1740, 870), (1075, 184)), ((1915, 840), (1130, 184)))
